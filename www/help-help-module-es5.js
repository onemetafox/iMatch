    ...
    function DZkv(module, __webpack_exports__, __webpack_require__) {
      ...
      var HelpPage = /*#__PURE__*/function () {
        ...
        _createClass(HelpPage, [{
          ...
          key: "openContactUs",
          value: function openContactUs(elementId) {
            this.showContactUs = !this.showContactUs;
            var y = document.getElementById(elementId).offsetTop - 123;
            console.log(y);
            this.content.scrollByPoint(0, y, 300);
          }
        }, {
          key: "openFeedback",
          value: function openFeedback(elementId) {
            this.showFeedback = !this.showFeedback; // const y = document.getElementById(elementId).offsetTop;
