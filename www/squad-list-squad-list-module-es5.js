          ...
          value: function ionViewWillEnter() {
            ...
            this.storageservice.storage.get('userDetails').then(function (val) {
              ...
              if (_this2.userDetails.userid != '') {
                ...
                _this2.common.postMethod('Listbesties', params).then(function (res) {
                  console.log('res:', res);
                  _this2.mysquads = res.details.squad;
                  console.log('mysquads', _this2.mysquads);

                  if (_this2.mysquads.length == 0) {
                    _this2.common.presentToast('You are having no `Squads` to show');
                  } else {
                    _this2.common.presentToast('You are having ' + res.details.squad.length + ' squad list members to show');
                  }
                }, function (err) {
