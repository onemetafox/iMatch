        ...
        _createClass(Tab5Page, [{
          ...
          value: function GetNotificationDetails() {
            ...
            this.storageservice.storage.get('userDetails').then(function (val) {
              ...
              var Api = 'getNotification/';

              _this3.common.http.get(_this3.common.ajx.BaseUrl + Api + userid).subscribe(function (res) {
                _this3.NotificationDetails = res.details;
                _this3.userDetails = res.details.user;
                _this3.userDetails.userid = _this3.userDetails.id;
              }, function (err) {
                console.log('err:', err);
              });
            });
          ...
          value: function openListSquad() {
            this.common.navCtrl.navigateForward(['squad-list-invitation'], {
              queryParams: this.userDetails
            });
          }
        }, {
