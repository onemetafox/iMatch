(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab6-tab6-module"], {
    ...
    function Uy4h(module, __webpack_exports__, __webpack_require__) {
      ...
      "DJEK"); // import { IOSFilePicker } from '@ionic-native/file-picker/ngx';
      ...
      var Tab6Page = /*#__PURE__*/function () {
        function Tab6Page(common, popoverController, actionSheetCtrl, storageservice, platform, fileChooser, transfer, filePath, mediaCapture) {
          var _this = this;
          ...
          this.common.route.queryParams.subscribe(function (resp) {
            ...
            console.log('userDetails:', _this.userDetails); // this.userDetails = this.userDetails;
          ...
          var Video_Ext = ['mp4', 'webm', 'mpg', 'mp2', 'mpeg', 'mpe', 'mpv', 'ogg', 'm4p', 'm4v', 'avi', 'wmv', 'mov', 'qt', 'flv', 'swf', 'avchd'];
            ...
            this.storageservice.storage.get('userDetails').then(function (val) {
              ...
              if (_this2.userDetails.userid != '') {
                ...
                _this2.common.postMethod('ClosedMatch', params).then(function (res) {
                  console.log(res.details); // this.closedMatchImage = res.details.image;
                  ...
                  _this2.closedMatch = res.details;
                });
          ...
          value: function gotoImageIcon(icon) {
            ...
            if (icon == 'image') {
              if (this.PersonalMatch.length !== 0) {
                ...
                this.common.presentLoading(); // this.closedMatch = this.closedMatch;
                // this.ionViewWillEnter();

                this.PersonalMatch = this.PersonalMatchImage;
                console.log('PersonalMatchImage', this.PersonalMatch);
                this.common.presentToast('Image Match is Successfully Displayed'); // this.common.hideLoader();
              } else {
                // this.common.showLoader();
                // this.closedMatch = this.closedMatch;
                this.common.presentToast('You are not having any image match'); // this.common.hideLoader();
              }
            } else if (icon == 'video') {
              if (this.PersonalMatch.length !== 0) {
                // this.common.showLoader();
                ...
                console.log('PersonalMatchVideo', this.PersonalMatch); // this.closedMatch = this.closedMatchVideo;

                this.common.presentToast('Video Match is Successfully Displayed'); // this.common.hideLoader();
              } else {
                // this.common.showLoader();
                // this.closedMatch = this.closedMatch;
                this.common.presentToast('You are not having any video match'); // this.common.hideLoader();
              ...
              if (this.PersonalMatch.length !== 0) {
                ...
                console.log('PersonalMatchAudio', this.PersonalMatch); // this.closedMatch = this.closedMatchAudio;

                this.common.presentToast('Audio Match is Successfully Displayed'); // this.common.hideLoader();
              } else {
                // this.common.showLoader();
                // this.closedMatch = this.closedMatch;
                this.common.presentToast('You are not having any audio match'); // this.common.hideLoader();
              ...
              if (this.PersonalMatch.length !== 0) {
                ...
                console.log('PersonalMatchText', this.PersonalMatch); // this.closedMatch = this.closedMatchText;
              ...
              if (this.PersonalMatch.length !== 0) {
                ...
                console.log('PersonalMatchLink', this.PersonalMatch); // this.closedMatch = this.closedMatchLink;
