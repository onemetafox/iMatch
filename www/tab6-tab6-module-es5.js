(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab6-tab6-module"], {
    ...
    /***/
    function CCDU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JT4w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Uy4h(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_tab6_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./tab6.page.html */
      "CCDU");
      /* harmony import */


      var _tab6_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./tab6.page.scss */
      "JT4w");
      /* harmony import */
      ...
      var Tab6Page = /*#__PURE__*/function () {
        function Tab6Page(common, popoverController, storageservice, platform) {
          var _this = this;
        ...
        _createClass(Tab6Page, [{
          key: "toOpenPersonalMatch",
          value: function toOpenPersonalMatch() {
            this.showOpenMatch = false;
          ...
          value: function ionViewWillEnter() {
            ...
            this.storageservice.storage.get('userDetails').then(function (val) {
              if (val != null) {
                ...
                var userid = _this2.userDetails.userid;
                var name = 'get_profile_pic/';

                _this2.common.http.get(_this2.common.ajx.BaseUrl + name + userid).subscribe(function (res) {
                  _this2.userArray = res.details[0];
                  _this2.userDetails = _this2.userArray;

                  _this2.storageservice.setStorage('userDetails', res.details[0]);
                });
              }
              ...
              if (_this2.userDetails.userid != '') {
                ...
                _this2.common.postMethod('PersonalMatch', params).then(function (res) {
                  if (res) _this2.PersonalMatch = res.details;
                });

                _this2.common.postMethod('ClosedMatch', params).then(function (res) {
                  if (res) _this2.closedMatch = res.details;
                });
          ...
          key: "OnOffButton",
          value: function OnOffButton(name) {
            if (name == 'Ongoing') {
          ...
          key: "gotoOnGoingMatch",
          value: function gotoOnGoingMatch() {
            ...
            this.common.navCtrl.navigateForward(['visitors-ongoing-match'], {
              queryParams: this.userArray
            });
          }
        }, {
          key: "goToPage",
          value: function goToPage(page) {
            var p = 'tabs/tab6/' + page;
          ...
          value: function gotoImageIcon(icon) {
            ...
            if (icon == 'image') {
              ...
              if (this.PersonalMatch.length !== 0) {
                ...
                this.PersonalMatch = this.PersonalMatchVideo; // this.closedMatch = this.closedMatchVideo;
              ...
              if (this.PersonalMatch.length !== 0) {
                // this.common.showLoader();
                this.common.presentLoading();
                this.PersonalMatch = this.PersonalMatchAudio; // this.closedMatch = this.closedMatchAudio;

                this.common.presentToast('Audio Match is Successfully Displayed'); // this.common.hideLoader();
              } else {
                this.common.showLoader(); // this.closedMatch = this.closedMatch;
              ...
              if (this.PersonalMatch.length !== 0) {
                // this.common.showLoader();
                this.common.presentLoading();
                this.PersonalMatch = this.PersonalMatchText; // this.closedMatch = this.closedMatchText;

                this.common.presentToast('Text Match is Successfully Displayed'); // this.common.hideLoader();
              } else {
                // this.common.showLoader();
                // this.closedMatch = this.closedMatch;
                this.common.presentToast('You are not having any text match'); // this.common.hideLoader();
              ...
              if (this.PersonalMatch.length !== 0) {
                // this.common.showLoader();
                this.common.presentLoading();
                this.PersonalMatch = this.PersonalMatchLink; // this.closedMatch = this.closedMatchLink;

                this.common.presentToast('Link Match is Successfully Displayed'); // this.common.hideLoader();
              } else {
                // this.common.showLoader();
                // this.closedMatch = this.closedMatch;
                this.common.presentToast('You are not having any link match'); // this.common.hideLoader();
          ...
          key: "goToFansOfPage",
          value: function goToFansOfPage() {
            this.common.navCtrl.navigateForward(['fans-of'], {
              queryParams: this.userDetails
            });
          }
        }, {
          key: "goToSquadListPage",
          value: function goToSquadListPage() {
          ...
          key: "goToOpenMatch",
          value: function goToOpenMatch(event, open, index, cat) {
            ...
            this.common.navCtrl.navigateForward(['open-match'], {
              queryParams: this.userDetails
            });
          }
        }, {
          ...
          key: "goToPersonalMatch1",
          value: function goToPersonalMatch1(e, match, index, cat) {
            this.userDetails.userType = 'owner';
            this.userDetails.personalMatchSlideIndex = index;
          ...
          key: "gotoBestiesAction",
          value: function gotoBestiesAction() {
            this.common.router.navigate(['/besties-actions']);
          }
        }, {
          key: "gotoWhatWouldIDoIf",
          value: function gotoWhatWouldIDoIf() {
            this.common.router.navigate(['/what-would-i-do']);
          }
        }, {
          key: "gotoBestMoments",
          value: function gotoBestMoments() {
            this.common.router.navigate(['/best-moments']);
          }
        }, {
          key: "scrollTo",
          value: function scrollTo(elementId) {// const x = document.getElementById(elementId).offsetTop;
          ...
          key: "gotoPersonalMatchUpload",
          value: function gotoPersonalMatchUpload() {
      ...
      Tab6Page = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'app-tab6',
      ...
      var PopoverComponent = /*#__PURE__*/function () {
        function PopoverComponent(popoverController, storageservice, common) {
          var _this3 = this;
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      try {
                        ...
                        } else if (val == 'fans-of') {// this.common.router.navigate(['/fans-of']);
                        }
                      } catch (e) {
    ...
    /***/
    function ufJq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ufJr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
