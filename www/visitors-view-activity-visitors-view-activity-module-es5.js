(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["visitors-view-activity-visitors-view-activity-module"], {
    ...
    /***/
    function PayK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VisitorsViewActivityPageModule", function () {
        return VisitorsViewActivityPageModule;
      });
      /* harmony import */
      ...
      var _visitors_view_activity_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./visitors-view-activity-routing.module */
      "QQ9p");
      /* harmony import */


      var _visitors_view_activity_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./visitors-view-activity.page */
      "nytW");

      var VisitorsViewActivityPageModule = function VisitorsViewActivityPageModule() {
        _classCallCheck(this, VisitorsViewActivityPageModule);
      };

      VisitorsViewActivityPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _visitors_view_activity_routing_module__WEBPACK_IMPORTED_MODULE_5__["VisitorsViewActivityPageRoutingModule"]],
    ...
    /***/
    function QQ9p(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VisitorsViewActivityPageRoutingModule", function () {
        return VisitorsViewActivityPageRoutingModule;
      });
      /* harmony import */
      ...
      var _visitors_view_activity_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./visitors-view-activity.page */
      "nytW");
      ...
      var VisitorsViewActivityPageRoutingModule = function VisitorsViewActivityPageRoutingModule() {
        _classCallCheck(this, VisitorsViewActivityPageRoutingModule);
      };

      VisitorsViewActivityPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function kXgI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function nytW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VisitorsViewActivityPage", function () {
        return VisitorsViewActivityPage;
      });
      /* harmony export (binding) */
      ...
      var _raw_loader_visitors_view_activity_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./visitors-view-activity.page.html */
      "5Umu");
      /* harmony import */


      var _visitors_view_activity_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./visitors-view-activity.page.scss */
      "kXgI");
      /* harmony import */
      ...
      var VisitorsViewActivityPage = /*#__PURE__*/function () {
        function VisitorsViewActivityPage(common, popoverController, storageservice, socialSharing) {
          var _this = this;

          _classCallCheck(this, VisitorsViewActivityPage);
        ...
        _createClass(VisitorsViewActivityPage, [{
          key: "ngOnInit",
          ...
          value: function ionViewWillEnter() {
            ...
            this.common.postMethod('ActivityPage', params).then(function (res) {
              _this2.UserInfo = res.details[0];
            });
            ...
            this.common.postMethod('OpenMatch', params).then(function (res) {
              if (res) _this2.OpenMatch = res.details;
            });
          }
        }, {
          key: "toShowPersonalMatch",
          value: function toShowPersonalMatch() {
            this.showOpenMatch = false;
            this.showPersonalMatch = !this.showPersonalMatch;
          }
        }, {
          key: "toShowOpenMatch",
          value: function toShowOpenMatch() {
            this.showPersonalMatch = true;
            this.showOpenMatch = !this.showOpenMatch;
          }
        }, {
          key: "gotoWhatWouldIDoIf",
          value: function gotoWhatWouldIDoIf(event, UserInfo) {
            this.common.navCtrl.navigateForward(['/what-would-i-do-visitor'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "gotoVisitorsFans",
          value: function gotoVisitorsFans(event, UserInfo) {
            this.common.navCtrl.navigateForward(['/visitors-fans-view'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "gotoVisitorsFansOf",
          value: function gotoVisitorsFansOf(event, UserInfo) {
            this.common.navCtrl.navigateForward(['/visitors-fans-of-view'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "gotoVisitorsBesties",
          value: function gotoVisitorsBesties(event, UserInfo) {
            this.common.navCtrl.navigateForward(['/visitors-besties-view'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "gotoVisitorsSquadList",
          value: function gotoVisitorsSquadList(event, UserInfo) {
            this.common.navCtrl.navigateForward(['/visitors-squad-list-view'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "gotoVisitorsBestMoments",
          value: function gotoVisitorsBestMoments(event, UserInfo) {
            this.common.navCtrl.navigateForward(['/best-moment-visitors-view'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "goToVisitorsOpenMatch",
          value: function goToVisitorsOpenMatch(e, open, index) {
            this.UserInfo.personalMatchSlideIndex = index;
            this.UserInfo.fileType = open.sender_image_type;
            this.common.navCtrl.navigateForward(['visitors-open-match'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          key: "gotoOngoingContest",
          value: function gotoOngoingContest(e, UserInfo) {
          ...
          key: "goToPersonalMatch",
          value: function goToPersonalMatch(e, match, index, cat) {
            this.UserInfo.userType = 'visitor';
            this.UserInfo.personalMatchSlideIndex = index;
            this.UserInfo.fileType = match.compare_data[0].image_type;
            this.UserInfo.category = cat;
            this.common.navCtrl.navigateForward(['/personal-match'], {
              queryParams: this.UserInfo
            });
          }
        }, {
          ...
          key: "toAddAsFavourite",
          value: function toAddAsFavourite() {
            var _this3 = this;
            ...
            this.common.postMethod('add_fan', params).then(function (res) {
              if (res.status == true) {
                ...
                _this3.common.presentToast('This User is Successfully Added To Your Fan List');

                _this3.common.router.navigate(['/fans'], {
                  queryParams: _this3.userDetails
                });
              } else if (res.message = 'Already added') {
                _this3.common.presentToast('This User is Already added to your Fan List');
              }
            }, function (err) {
              console.log('Error:', err);

              _this3.common.presentToast('Adding this user to your fan list failed');
            });
          }
        }, {
          key: "toShareProfile",
          value: function toShareProfile() {
            var msg = 'Share iMatch with your friends:';
            var userName = this.UserInfo.username;
            var img = 'https://icons.iconarchive.com/icons/dtafalonso/android-lollipop/256/Youtube-icon.png';
            var content = 'Hai friend ... I am ';
            this.socialSharing.share(img, content, userName, msg).then(function () {// Success!
      ...
      VisitorsViewActivityPage.ctorParameters = function () {
        return [{
      ...
      VisitorsViewActivityPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      var PopoverComponent = /*#__PURE__*/function () {
        function PopoverComponent(popoverController, storageservice, common, navParams) {
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      try {
                        ...
                        if (val == 'message') {
                          this.toSendMessage();
                        } else if (val == 'favourite') {// this.toAddAsFavourite();
                        } else if (val == 'squad') {
                          this.toAddAsSquad();
                        } else if (val == 'bestie') {
                          this.toAddAsBestie();
          ...
          value: function toSendMessage() {
            ...
            this.common.postMethod('Chat', params).then(function (res) {
              if (res.status == true) {
                ...
                _this5.common.presentToast(' Message Send Successful ');

                _this5.common.router.navigate(['/chat']);
              } else {
                _this5.common.presentLoading();

                _this5.common.presentToast(' Message Sending Failed ... Try After Sometime ! ');
              }
            }, function (err) {
              console.log('Error:', err);
          ...
          value: function toAddAsFavourite() {
            ...
            this.common.postMethod('add_fan', params).then(function (res) {
              if (res.status == true) {
                ...
                _this6.common.presentToast('This User is Successfully Added To Your Fan List');

                _this6.common.router.navigate(['/fans'], {
                  queryParams: _this6.userDetails
                });
              } else if (res.message = 'Already added') {
                _this6.common.presentToast('This User is Already added to your Fan List');
              }
            }, function (err) {
              console.log('Error:', err);

              _this6.common.presentToast('Adding this user to your fan list failed');
            });
          }
        }, {
          key: "toAddAsBestie",
          value: function toAddAsBestie() {
            var _this7 = this;
            ...
            this.common.postMethod('add_bestie', params).then(function (res) {
              if (res.status == true) {
                _this7.common.presentLoading();

                _this7.common.presentToast('This User is Successfully Added To Your Bestie List');

                _this7.common.router.navigate(['/besties-before']);
              } else if (res.message = 'Already added') {
                _this7.common.presentToast('This User is Already added to your Bestie List');
              }
            }, function (err) {
              console.log('Error:', err);

              _this7.common.presentToast('Adding this user to your Bestie list failed');
            });
          }
        }, {
          key: "toAddAsSquad",
          value: function toAddAsSquad() {
            var _this8 = this;
            ...
            this.common.postMethod('add_bestie', params).then(function (res) {
              if (res.status == true) {
                _this8.common.presentLoading();

                _this8.common.presentToast('This User is Successfully Added To Your Squad List');

                _this8.common.router.navigate(['/bestie']);
              } else if (res.message = 'Already added') {
                _this8.common.presentToast('This User is Already added to your Squad List');
              }
            }, function (err) {
              _this8.common.presentToast('Adding this user to your Squad list failed');
...
//# sourceMappingURL=visitors-view-activity-visitors-view-activity-module-es5.js.map