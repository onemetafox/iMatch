        ...
        _createClass(VisitorsViewActivityPage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.common.postMethod('PersonalMatch', params).then(function (res) {
              console.log('res:', res);
              _this2.PersonalMatch = res.details; // this.PersonalMatchImage = res.details.image;
              ...
              console.log('PersonalMatch:', _this2.PersonalMatch);
            });
            this.common.postMethod('OpenMatch', params).then(function (res) {
              console.log('OpenMatch:', res); // this.OpenMatch = res.details;
              ...
              _this2.OpenMatchText = res.details.text; // console.log('OpenMatch:',this.OpenMatch);

              if (_this2.OpenMatchAudio.length !== 0) {
                for (var i = 0; i < _this2.OpenMatchAudio.length; i++) {
                  _this2.OpenMatch.push(_this2.OpenMatchAudio[i]);
                }

                console.log('OpenMatch:', _this2.OpenMatch);
              }

              if (_this2.OpenMatchImage.length !== 0) {
                for (var _i = 0; _i < _this2.OpenMatchImage.length; _i++) {
                  _this2.OpenMatch.push(_this2.OpenMatchImage[_i]);
                }

                console.log('OpenMatch:', _this2.OpenMatch);
              }

              if (_this2.OpenMatchLink.length !== 0) {
                for (var _i2 = 0; _i2 < _this2.OpenMatchLink.length; _i2++) {
                  _this2.OpenMatch.push(_this2.OpenMatchLink[_i2]);
                }

                console.log('OpenMatch:', _this2.OpenMatch);
              }

              if (_this2.OpenMatchText.length !== 0) {
                for (var _i3 = 0; _i3 < _this2.OpenMatchText.length; _i3++) {
                  _this2.OpenMatch.push(_this2.OpenMatchText[_i3]);
                }

                console.log('OpenMatch:', _this2.OpenMatch);
              }

              if (_this2.OpenMatchVideo.length !== 0) {
                for (var _i4 = 0; _i4 < _this2.OpenMatchVideo.length; _i4++) {
                  _this2.OpenMatch.push(_this2.OpenMatchVideo[_i4]);
                }
          ...
          value: function toSendMessage() {
            ...
            this.common.postMethod('Chat', params).then(function (res) {
              ...
              if (res.status == true) {
                ...
                _this4.common.presentToast(' Message Send Successful ');

                _this4.common.router.navigate(['/chat']);
              } else {
                _this4.common.presentLoading();

                _this4.common.presentToast(' Message Sending Failed ... Try After Sometime ! ');
              }
            }, function (err) {
          ...
          value: function toAddAsFavourite() {
            ...
            this.common.postMethod('add_fan', params).then(function (res) {
              ...
              if (res.status == true) {
                ...
                _this5.common.presentToast('This User is Successfully Added To Your Fan List');

                _this5.common.router.navigate(['/fans'], {
                  queryParams: _this5.userDetails
                });
              } else if (res.message = 'Already added') {
                _this5.common.presentToast('This User is Already added to your Fan List');
              }
            }, function (err) {
              console.log('Error:', err);
              console.log(err.headers);

              _this5.common.presentToast('Adding this user to your fan list failed');
            });
          }
        }, {
          key: "toAddAsBestie",
          value: function toAddAsBestie() {
            ...
            this.common.postMethod('add_bestie', params).then(function (res) {
              ...
              if (res.status == true) {
                ...
                _this6.common.presentToast('This User is Successfully Added To Your Bestie List');

                _this6.common.router.navigate(['/besties-before']);
              } else if (res.message = 'Already added') {
                _this6.common.presentToast('This User is Already added to your Bestie List');
              }
            }, function (err) {
              console.log('Error:', err);
              console.log(err.headers);

              _this6.common.presentToast('Adding this user to your Bestie list failed');
            });
          }
        }, {
          key: "toAddAsSquad",
          value: function toAddAsSquad() {
            ...
            this.common.postMethod('add_bestie', params).then(function (res) {
              ...
              if (res.status == true) {
                ...
                _this7.common.presentToast('This User is Successfully Added To Your Squad List');

                _this7.common.router.navigate(['/bestie']);
              } else if (res.message = 'Already added') {
                _this7.common.presentToast('This User is Already added to your Squad List');
              }
            }, function (err) {
              _this7.common.presentToast('Adding this user to your Squad list failed');
