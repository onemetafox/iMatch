...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WhatWouldIDoPageRoutingModule", function() { return WhatWouldIDoPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "iInd");
/* harmony import */ var _what_would_i_do_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./what-would-i-do.page */ "SWwE");
...
let WhatWouldIDoPageRoutingModule = class WhatWouldIDoPageRoutingModule {
};
WhatWouldIDoPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WhatWouldIDoPage", function() { return WhatWouldIDoPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_what_would_i_do_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./what-would-i-do.page.html */ "T2d9");
/* harmony import */ var _what_would_i_do_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./what-would-i-do.page.scss */ "JfcX");
...
let WhatWouldIDoPage = class WhatWouldIDoPage {
    ...
    toSendComment(event, messages) {
        ...
        console.log('params:', params);
        this.common.postMethod('CommentAnswer', params).then((res) => {
            console.log('res:', res);
            if (res.status == true) {
    ...
    toSendAnswer(event, AdminQuestions) {
        ...
        console.log('params:', params);
        this.common.postMethod('AnswerMessage', params).then((res) => {
            console.log('res:', res);
            if (res.status == true) {
    ...
    toLikeAnswer1(event, AdminQuestions) {
        ...
        console.log('params:', params);
        this.common.postMethod('CommentLike', params).then((res) => {
            console.log('res:', res);
            this.ionViewWillEnter();
        });
    }
    ...
    toSendiQuery(event, messages) {
        ...
        if (this.MyiQuery.length != 7 && this.MyiQuery.length > 7) {
            ...
            console.log('params:', params);
            this.common.postMethod('MyiQuery', params).then((res) => {
                console.log('res', res);
                if (res.status == true) {
    ...
    toRemoveiQuery(event, iQuery) {
        ...
        this.common.postMethod('RemoveiQuery', params).then((res) => {
            console.log('res:', res);
            if (res.status == true) {
                this.ionViewWillEnter();
...
WhatWouldIDoPage.ctorParameters = () => [
    { type: _services_common_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"] },
    { type: _services_storage_service__WEBPACK_IMPORTED_MODULE_4__["StorageService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"] }
];
WhatWouldIDoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WhatWouldIDoPageModule", function() { return WhatWouldIDoPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "SVse");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "s7LF");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "sZkV");
/* harmony import */ var _what_would_i_do_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./what-would-i-do-routing.module */ "RMfz");
/* harmony import */ var _what_would_i_do_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./what-would-i-do.page */ "SWwE");
...
let WhatWouldIDoPageModule = class WhatWouldIDoPageModule {
};
WhatWouldIDoPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _what_would_i_do_routing_module__WEBPACK_IMPORTED_MODULE_5__["WhatWouldIDoPageRoutingModule"]
        ],
...
//# sourceMappingURL=what-would-i-do-what-would-i-do-module-es2015.js.map