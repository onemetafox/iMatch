      ...
      var LoginPage = /*#__PURE__*/function () {
        ...
        _createClass(LoginPage, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.common.platform.is("capacitor" || false)) {} else {
                    ...
                    case 0:
                      ...
                      this.twit.login().then(function (res) {
                        ...
                        _this5.twit.showUser().then(function (user) {
                          ...
                          var profile_image = err.profile_image_url_https.replace('_normal', ''); // this.storageservice.setStorage('twitter_user', {
                          //   name: err.name,
                        ...
                        _this5.twit.login().then(function (res) {
                          _this5.twit.showUser().then(function (user) {}, function (err) {
                            console.log('Error:', err);
                          });
                        }, function (err) {
                          console.log('Error:', err);
