(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab8-tab8-module"], {
      ...
      var Tab8Page = /*#__PURE__*/function () {
        ...
        _createClass(Tab8Page, [{
          ...
          value: function ionSlideChanges(slides) {
            ...
            console.log('selectedSlide:', this.selectedSlide); // slides.getActiveIndex().then(
            //   (slidesIndex) => {
            //     if (slidesIndex == 2) {
          ...
          value: function nextSlide() {
            console.log('Next Button Clicked'); // this.slides.slideNext();
          }
        }, {
          ...
          value: function ionViewWillEnter() {
            ...
            this.common.postMethod('OngoingMatch', params).then(function (res) {
              ...
              if (res.status == true) {
                _this2.ongoingDetailsAudio = res.details.audio;
                console.log('ongoingDetailsAudio:', _this2.ongoingDetailsAudio);
                _this2.ongoingDetailsImage = res.details.image;
                console.log('ongoingDetailsImage:', _this2.ongoingDetailsImage);
                _this2.ongoingDetailsLink = res.details.link;
                console.log('ongoingDetailsLink:', _this2.ongoingDetailsLink);
                _this2.ongoingDetailsText = res.details.text;
                console.log('ongoingDetailsText:', _this2.ongoingDetailsText);
                _this2.ongoingDetailsVideo = res.details.video;
                console.log('ongoingDetailsVideo:', _this2.ongoingDetailsVideo);

                if (_this2.ongoingDetailsAudio.length !== 0) {
                  for (var i = 0; i < _this2.ongoingDetailsAudio.length; i++) {
                    _this2.ongoingDetails.push(_this2.ongoingDetailsAudio[i]);
                  }

                  console.log('ongoingDetails:', _this2.ongoingDetails);
                }

                if (_this2.ongoingDetailsImage.length !== 0) {
                  for (var _i = 0; _i < _this2.ongoingDetailsImage.length; _i++) {
                    _this2.ongoingDetails.push(_this2.ongoingDetailsImage[_i]);
                  }

                  console.log('ongoingDetails:', _this2.ongoingDetails);
                }

                if (_this2.ongoingDetailsLink.length !== 0) {
                  for (var _i2 = 0; _i2 < _this2.ongoingDetailsLink.length; _i2++) {
                    _this2.ongoingDetails.push(_this2.ongoingDetailsLink[_i2]);
                  }

                  console.log('ongoingDetails:', _this2.ongoingDetails);
                }

                if (_this2.ongoingDetailsText.length !== 0) {
                  for (var _i3 = 0; _i3 < _this2.ongoingDetailsText.length; _i3++) {
                    _this2.ongoingDetails.push(_this2.ongoingDetailsText[_i3]);
                  }

                  console.log('ongoingDetails:', _this2.ongoingDetails);
                }

                if (_this2.ongoingDetailsVideo.length !== 0) {
                  for (var _i4 = 0; _i4 < _this2.ongoingDetailsVideo.length; _i4++) {
                    _this2.ongoingDetails.push(_this2.ongoingDetailsVideo[_i4]);
                  }
            ...
            this.common.postMethod('Recommended_for_you', params).then(function (res) {
              console.log('res:', res);
              _this2.RecommendedForYou = res.details; // this.SlideSecond = res.details[1];
            ...
            if (icon == 'image') {
              ...
              this.common.postMethod('OngoingMatch', params).then(function (res) {
                ...
                if (res.details.image.length != 0) {
                  ...
                  console.log('OngoingMatch:', _this3.ongoingDetails);
                } else {
          ...
          value: function swipeNext() {
            console.log('Swipe Next Icon Clicked'); // this.slides.slideNext(speed?: 400 | , runCallbacks?: false | undefined) => Promise<void>;
          }
        }, {
          key: "gotoFunny",
          ...
          value: function gotoNews() {
            console.log('News Button Clicked'); // this.common.router.navigate(['/']);
          }
        }, {
          key: "gotoBlog",
    ...
    function Nr0(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "/* PAGE HEADER */\nion-content {\n  --background: url('home-bg.png') 0 0/100% 100% no-repeat;\n}\n.tabone_header {\n  background: #707072;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 5px 0;\n}\n.home-content {\n  background: #707072;\n}\n.Hamburg_icon {\n  color: #ffffff;\n}\n.tabone_header_right {\n  display: flex;\n  align-items: center;\n  margin-right: 20px;\n}\n.logo-img {\n  height: 25px;\n  max-width: 25px;\n}\n.ongoing-img-icons {\n  margin: 0px 5px;\n  background: #9E9E9E;\n  padding: 5px 5px;\n  border-radius: 5px;\n}\n/* PAGE CONTENT */\n/* SEARCH SECTION */\n.home-searchbar input {\n  background: #ffffff;\n  border-radius: 10px;\n}\n/* IMAGE SLIDE SECTION */\n.home_slide_div {\n  padding: 10px;\n}\nion-slides {\n  height: 100%;\n}\n.swiper-slide img {\n  height: auto;\n  max-height: 100%;\n  max-width: 100%;\n  border-radius: 5px;\n}\n/* MULTIPLE SLIDERS SECTION */\n.main_multiple_slide {\n  display: flex;\n  padding: 0px 10px;\n}\n.sub_multiple_slide {\n  width: 17%;\n  text-align: center;\n}\n.circle_multiple_slide {\n  background: #fcbb3b;\n  padding: 15px;\n  border-radius: 50%;\n  display: inline-flex;\n}\n.circle_multiple_slide img {\n  height: 25px;\n  width: 25px;\n}\n.sub_multiple_slide p {\n  font-size: 8px;\n  /* font-weight: 600; */\n  color: #ffffff;\n  line-height: 10px;\n}\n.slide-next-arrow {\n  background: #707072;\n  position: absolute;\n  padding: 14px 7px;\n  right: 0;\n}\n.multiple-slide-more {\n  float: right;\n  margin-top: -8px;\n  margin-right: 5px;\n}\n.multiple-slide-more .multiple-slide-more_button {\n  color: #ffffff;\n  border: 1px solid #ffffff;\n  padding: 6px 8px;\n  border-radius: 25px;\n  font-size: 12px;\n  height: 25px;\n  text-transform: uppercase;\n}\n/* ONGOING CONTEST SECTION */\n.home-ongoing-contest {\n  padding: 10px;\n  position: relative;\n}\n.home-ongoing-contest p {\n  color: #ffffff;\n  letter-spacing: 1px;\n}\n.contest-image-div {\n  display: flex;\n}\n.image-div {\n  height: 70px;\n  width: 70px;\n  max-width: 33.3%;\n}\n.image-div img {\n  width: 100%;\n  height: 100%;\n}\n.vs-image {\n  position: absolute;\n  left: 17%;\n  margin-top: 24px;\n}\n.vs-image img {\n  width: 30px;\n  height: 30px;\n}\n.vs-image-two {\n  position: absolute;\n  top: 50%;\n  left: 62%;\n}\n.vs-image-two img {\n  width: 30px;\n  height: 30px;\n}\n.go-icon {\n  justify-content: center;\n  display: flex;\n  margin-top: 5px;\n}\n.go-icon img {\n  height: 40px;\n  width: 40px;\n}\n/* ORANGE BOXES SECTION */\n.main_orange_row {\n  display: flex;\n  padding: 0 10px;\n  justify-content: space-between;\n}\n.sub_orange_row {\n  height: 100px;\n  width: 100px;\n  background-color: #fcbb3b;\n  border-radius: 5px;\n  padding: 20px;\n}\n.main_orange_row p {\n  color: #ffffff;\n  font-size: 10px;\n}\n/* RECOMMENDED SECTION */\n.recommended_section {\n  padding: 15px 5px 15px 5px;\n}\n.recommended_section p {\n  color: #ffffff;\n  letter-spacing: 1px;\n}\n.recommended_main_div {\n  display: flex;\n  width: 100%;\n}\n.recommended_sub_div {\n  border: 0.1px solid #ffffff61;\n  border-radius: 5px;\n  padding: 10px;\n  height: 105px;\n  text-align: center;\n}\n.recommended_sub_div img {\n  width: 70px;\n  height: 60px;\n  border-radius: 50%;\n  position: relative;\n  bottom: 5px;\n}\n.recommended-next-arrow {\n  background: #707072;\n  position: absolute;\n  padding: 35px 20px;\n  right: 0;\n  bottom: -280px;\n}\n.recommended_main_div p {\n  color: #ffffff;\n  font-size: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
